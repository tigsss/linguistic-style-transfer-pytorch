...
def read_yelp():
    ...
    #positive is one
    x, y = [], []
    with open("data/yelp/sentiment.train.pos.txt", "r", encoding="utf-8") as f:
        for line in f:
            if line[-1] == "\n":
                line = line[:-1]
            x.append(line.split())
    ...
    with open("data/yelp/sentiment.train.neg.txt", "r", encoding="utf-8") as f:
        for line in f:
            if line[-1] == "\n":
                line = line[:-1]
            x.append(line.split())
    ...
    #positive is one
    x, y = [], []
    with open("data/yelp/sentiment.dev.pos.txt", "r", encoding="utf-8") as f:
        for line in f:
            if line[-1] == "\n":
                line = line[:-1]
            x.append(line.split())
    ...
    with open("data/yelp/sentiment.dev.neg.txt", "r", encoding="utf-8") as f:
        for line in f:
            if line[-1] == "\n":
                line = line[:-1]
            x.append(line.split())
    ...
    #positive is one
    x, y = [], []
    with open("data/yelp/sentiment.test.pos.txt", "r", encoding="utf-8") as f:
        for line in f:
            if line[-1] == "\n":
                line = line[:-1]
            x.append(line.split())
    ...
    with open("data/yelp/sentiment.test.neg.txt", "r", encoding="utf-8") as f:
        for line in f:
            if line[-1] == "\n":
                line = line[:-1]
            x.append(line.split())
