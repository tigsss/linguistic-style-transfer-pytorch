...
def train(data, params):
    if params["MODEL"] != "rand":
        ...
        word_vectors = KeyedVectors.load_word2vec_format("embedding.txt", binary=False)
...
def main():
    ...
    parser.add_argument("--dataset", default="TREC", help="available datasets: MR, TREC, yelp")
